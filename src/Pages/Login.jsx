    ...
    return (
        ...
        <div className="flex h-[700px] w-full">
            ...
            */}
                    ...
                    <p className="text-gray-500/90 text-sm mt-4">Don’t have an account? <a className="text-indigo-400 hover:underline"><NavLink to="/Registration">Sign up</NavLink></a></p>
                </form>
            </div>
        </div>
    );
